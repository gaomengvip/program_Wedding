...
@implementation HSLFController

- (void)viewDidLoad {
    [super viewDidLoad];
    _currentPage = 1;
    
    [self requestWithUrl:kHLCH_url(12,_currentPage)];
...
//        weakSelf.tableView.frame = CGRectMake(0, 63, weakSelf.view.frame.size.width, weakSelf.view.frame.size.height - 50);
    ...
    [self.tableView addInfiniteScrollingWithActionHandler:^{
        ...
        [weakSelf requestWithUrl:kHLCH_url(12,weakSelf.currentPage)];
